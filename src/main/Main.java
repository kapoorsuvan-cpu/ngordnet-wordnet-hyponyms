...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // *** DEV MODE — small WordNet + small NGram file ***
        WordNet wn = new WordNet(SYNSETS_SIZE16_FILE, HYPONYMS_SIZE16_FILE);
        NGramMap ngm = new NGramMap(YEAR_HISTORY_FILE, WORD_HISTORY_SIZE14377_FILE);

        server.register("hyponyms", new HyponymsHandler(wn, ngm));
